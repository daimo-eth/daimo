...
const en: Translation = {
  ...
  send_note: {
    ...
    help: {
      ...
      description: {
        ...
        secondPara: "You can cancel an unclaimed link to get your money back.",
        thirdPara: "They're self-custody. The key is part of the URL.",
        fourthPara: `Each link doubles as a Daimo invite. Plus, anyone with the link can 
  ...
  allowNotifs: {
    ...
    skipButton: "Skip",
    instructions: "You will only be notified about activity on your account.",
  },
  ...
  existing: {
    ...
    scanQR: `Scan this QR code from another device to add this phone to an 
  ...
  missingKey: {
    ...
    keyErrorDesc: {
      noKey: {
        title: "New phone?",
        desc: `We found your account, but no device key. Keys in secure hardware 
        never leave your device, so they don't transfer when you get a new phone.
        Log out, then log in using a backup key.`,
      },
      removedKey: {
        title: "Device removed",
        desc: `It looks like the key on this device was removed from your 
  ...
  onboardingEnterInvite: {
    ...
    instructions: `Type your invite code below or paste a link.\nJoin the 
  ...
  onboardingIntro: {
    ...
    helpModalUSDC: {
      description: `USDC is a regulated, digital currency that can always be redeemed 
        1:1 for US dollars.`,
  ...
  onboardingSetupKey: {
    ...
    pin: {
      generateDescription: `Generate your Daimo device key. This key is generated 
      and stored on your device, and secures access to your Daimo account.`,
      failedDescription: `Authentication failed. Does your phone have a secure 
  ...
  sendNote: {
    ...
    help: {
      ...
      description: {
        ...
        secondPara: "You can cancel an unclaimed link to get your money back.",
        thirdPara: "They're self-custody. The key is part of the URL.",
        fourthPara: `Each link doubles as a Daimo invite. Plus, anyone with the 
  ...
  seedPhrase: {
    ...
    description: `This seed phrase will be added to your account, allowing you 
  ...
  settings: {
    ...
    devices: {
      ...
      passkeys: {
        ...
        description: {
          firstPara: `Passkeys are a convenient and phishing-resistant 
          alternative to seed phrases`,
          secondPara: `Passkeys are generated and stored in your password 
  ...
  debugBottom: {
    ...
    description: `Contact us on Telegram, then tap Send Debug Log to send us more 
  ...
  withdrawInstructionsBottom: {
    ...
    wallet: {
      ...
      description: `Tap Send, then paste in your wallet address. Remember that 
    ...
    coinbase: {
      ...
      sendToAddress: `Use Daimo to send to the address shown. Funds should appear 
