...
type RootTranslation = {
	...
	invitesNotification: {
		 ...
		 * @param {string | number | boolean} inviteCount
		 */
	...
	swapNotification: {
		 ...
		 * @param {unknown} coinName
		 * @param {unknown} readableAmount
		 */
	...
	sendTransferButton: {
		disabledReason: {
			 ...
			 * @param {unknown} minTransferAmount
			 */
	...
	invite: {
		...
		referral: {
			 ...
			 * @param {unknown} bonusDollarsInvitee
			 */
			 ...
			 * @param {unknown} bonusDollarsInviter
			 */
...
export type TranslationFunctions = {
	...
	historyOp: {
		...
		whyNoFees: {
			...
			description: {
				 ...
				 */
				firstPara: (arg: { chainName: unknown }) => LocalizedString
				/**
		...
		feeText: {
			 ...
			 * {amount} FEE
			 */
			fee: (arg: { amount: unknown }) => LocalizedString
		}
	}
	addDevice: {
		/**
		...
		scanQR: {
			 ...
			 * Scanned {slot}
			 */
			scanned: (arg: { slot: unknown }) => LocalizedString
			/**
			 * Add {slot}
			 */
			add: (arg: { slot: unknown }) => LocalizedString
		}
	}
	addKeySlot: {
		/**
	...
	device: {
		...
		remove: {
			 ...
			 */
			title: (arg: { deviceName: unknown }) => LocalizedString
			/**
			 ...
			 * Remove {deviceName}
			 */
			remove: (arg: { deviceName: unknown }) => LocalizedString
			/**
			 * Cancel
			 */
			cancel: () => LocalizedString
	...
	note: {
		...
		accept: {
			 ...
			 */
			long: (arg: { dollars: unknown }) => LocalizedString
			/**
			 * Accepting link...
			 */
		...
		accepted: {
			 ...
			 * Accepted by {name}
			 */
			long: (arg: { name: unknown }) => LocalizedString
		}
		cancel: {
			/**
			 * Cancel
		...
		send: {
			 ...
			 * {name} sent
			 */
			other: (arg: { name: unknown }) => LocalizedString
		}
	}
	send_note: {
		/**
	...
	invitesNotification: {
		 ...
		 */
		description: (arg: { inviteCount: string | number | boolean }) => LocalizedString
	}
	notifications: {
		/**
		 * Notifications
	...
	swapNotification: {
		 ...
		 */
		msg: (arg: { coinName: unknown, readableAmount: unknown }) => LocalizedString
	}
	allowNotifs: {
		/**
		 * Notifications
	...
	logIn: {
		 ...
		 * LOG IN WITH {keyType}
		 */
		button: (arg: { keyType: unknown }) => LocalizedString
		fromSeed: {
			/**
	...
	fulfillRequest: {
		...
		statusMsg: {
			 ...
			 */
			totalDollars: (arg: { dollars: unknown }) => LocalizedString
		}
	}
	memoDisplay: {
		/**
		 * memo {status}
		 */
		status: (arg: { status: unknown }) => LocalizedString
		/**
		 * WHAT'S THIS FOR?
		 */
		placeholder: () => LocalizedString
	...
	routeDisplay: {
		 ...
		 */
		theyWillReceive: (arg: { amount: unknown, tokenSymbol: unknown }) => LocalizedString
	}
	sendNav: {
		/**
		 * Send
	...
	sendNote: {
		 ...
		 */
		info: (arg: { tokenSymbol: unknown }) => LocalizedString
		help: {
			/**
			 * How Payment Links Work
			 */
	...
	sendTransferButton: {
		disabledReason: {
			 ...
			 */
			min: (arg: { minTransferAmount: unknown }) => LocalizedString
		}
		/**
		 * HOLD TO SEND
		 */
		...
		statusMsg: {
			 ...
			 */
			insufficientFundsPlusFee: (arg: { totalStr: unknown }) => LocalizedString
			/**
			 * Insufficient funds
			 */
			insufficientFunds: () => LocalizedString
			 ...
			 */
			totalDollars: (arg: { totalStr: unknown }) => LocalizedString
			/**
			 * Payments are public
			 */
			paymentsPublic: () => LocalizedString
	...
	sendTransferScreen: {
		 ...
		 */
		firstTime: (arg: { name: unknown }) => LocalizedString
	}
	deposit: {
		/**
		 * Deposit or Withdraw
		...
		landline: {
			 ...
			 */
			optionRowTitle: (arg: { timeAgo: unknown }) => LocalizedString
		}
		binance: {
			/**
	...
	home: {
		 ...
		 */
		pending: (arg: { pendingDollars: unknown }) => LocalizedString
		/**
	...
	invite: {
		 ...
		 * +{moreInvitees} more
		 */
		more: (arg: { moreInvitees: unknown }) => LocalizedString
		/**
		 * You've invited {invited} friend{{s}}
		 */
		invited: (arg: { invited: string | number | boolean }) => LocalizedString
		/**
		 * {usesLeft} invite{{s}} left
		 */
		left: (arg: { usesLeft: string | number | boolean }) => LocalizedString
		locked: {
			/**
		...
		referral: {
			 ...
			 */
			creditForInvite: (arg: { bonusSubtitle: unknown }) => LocalizedString
			/**
			 * and we'll send you both ${bonusDollarsInvitee} USDC
			 */
			bonusBoth: (arg: { bonusDollarsInvitee: unknown }) => LocalizedString
			/**
			 * and we'll send them ${bonusDollarsInvitee} USDC
			 */
			bonusInvitee: (arg: { bonusDollarsInvitee: unknown }) => LocalizedString
			/**
			 * and we'll send you ${bonusDollarsInviter} USDC
			 */
			bonusInviter: (arg: { bonusDollarsInviter: unknown }) => LocalizedString
			/**
			 * Invite Code
			 */
	...
	profile: {
		...
		error: {
			account: {
				 ...
				 */
				msg: (arg: { account: unknown }) => LocalizedString
			}
			invite: {
				/**
				 * Invite not found
				 ...
				 */
				msg: (arg: { code: unknown }) => LocalizedString
			}
		}
		subtitle: {
			/**
			 ...
			 * Joined {timeAgo}
			 */
			joined: (arg: { timeAgo: unknown }) => LocalizedString
		}
	}
	qr: {
		title: {
	...
	settings: {
		 ...
		 * Added {timeAgo}
		 */
		addedAgo: (arg: { timeAgo: unknown }) => LocalizedString
		details: {
			/**
			 * Device details
			 */
	...
	yourInvites: {
		 ...
		 * Joined {timeAgo} ago
		 */
		joinedAgo: (arg: { timeAgo: unknown }) => LocalizedString
	}
	amountInput: {
		/**
		 * {dollars} available
		 */
		dollarsAvailable: (arg: { dollars: unknown }) => LocalizedString
	}
	offlineHeader: {
		/**
		 * Offline
	...
	searchResults: {
		 ...
		 * Sent {timeAgo}
		 */
		sentAgo: (arg: { timeAgo: unknown }) => LocalizedString
		/**
		 * Received {timeAgo}
		 */
		receivedAgo: (arg: { timeAgo: unknown }) => LocalizedString
		extra: {
			/**
			 * Send to contact
			 */
	...
	createBackup: {
		...
		addKey: {
			 ...
			 */
			button: (arg: { slotType: unknown }) => LocalizedString
		}
		recommended: {
			/**
			 * REC.
	...
	depositAddressBottom: {
		 ...
		 */
		description: (arg: { tokenSymbol: unknown }) => LocalizedString
		checkChain: {
			/**
			 * On 
			 */
	...
	farcasterBottom: {
		 ...
		 * Welcome, {fcUsername}
		 */
		welcome: (arg: { fcUsername: unknown }) => LocalizedString
		/**
		 * Loading...
		 */
		loading: () => LocalizedString
