...
uint256 constant ZKSYNC_MAINNET = 324;
...
address constant ZKSYNC_MAINNET_BRIDGED_USDC = 0x3355df6D4c9C3035724Fd0e3914dE96A5a83aaf4;
...
function _getBridgedUSDCAddress(uint256 chainId) pure returns (address) {
    ...
    if (chainId == ZKSYNC_MAINNET) return ZKSYNC_MAINNET_BRIDGED_USDC;
...
address constant ZKSYNC_MAINNET_SPOKE_POOL = 0xE0B015E54d54fc84a6cB9B666099c46adE9335FF;
...
function _getSpokePoolAddress(uint256 chainId) pure returns (address) {
    ...
    if (chainId == ZKSYNC_MAINNET) return ZKSYNC_MAINNET_SPOKE_POOL;
